...
public class MyController {
	 ...
	 *
	 * 서버입장에서
	 * GET: http://localhost:8080/hello/insert?name=홍길동 으로
	 * 요청을 받았으면
	 ...
	 * 
	 * Spring framework 내부에서
	 * reflection이라는 코드가 작동되어서
	 * 전달받은 변수이름과 Java method의 맨개변수와 
	 * 이름매칭방법으로 변수를 받는다.
	 * 
	 * 이런 코드는 개발자가 신경쓰지 않아도
	 * 자동으로 작동되는 코드이다
	 * getParameter() 등의 코드를 이제는 잊어도 된다.
	 * 
	 * 그런데,
	 * Java method의 변수를 String 형이 아닌 것으로 
	 * 		숫자형, Boolean형 등
	 * 
	 ...
	 *  Reflaction 코드가 주앋ㄴ되고
	 *  Spring의 Dispatcjher는 Web 400 Status Code를 
	 *  응답ㅎ 버린다.
	 *  
	 *   또한 어떤 구체적인 문제가 발생했는지
	 *   알려주지 않는다.
	 */
