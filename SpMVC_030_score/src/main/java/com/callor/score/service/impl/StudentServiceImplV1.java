...
//		}
		...
		List<Map<String, String>> scoreMaps
				= new ArrayList<>();
		//= new ArrayList<>(Map<String, String>); 호환성을 위해 이렇게 쓰긴하는데 우리버전은 위처럼 써도됨
		 ...
		 * 모든 테이터를 insertOrUpdate를 수행한다음
		 * 강제로 exception을 발생하였다.
		 * 
		 * 그랬더니 transactionManager에 의해서
		 * 모든 Insert Or Update 가 Rollback되어 버렸다.
		 */
